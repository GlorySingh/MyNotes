  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') {
    if(isset($_POST['snoEdit'])) {
      ...
      if($res) {
        ...
        echo "Note could not be updated.<br>";
      }
    } else {
        $title = $_POST['title'];
...
<html lang="en">
  <head>
    ...
    <title>NoteKaro</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">NoteKaro</a>
        <button
          ...
          <tbody>
            <?php
              ...
              while($arr = mysqli_fetch_assoc($res)) {
                $sno++;
                echo '<tr><th scope="row">'.$sno.'</th><td>'.$arr['title'].'</td><td>'.$arr['description'].'</td><td><button class="btn btn-sm btn-primary edit" id='.$arr['sno'].'>Edit</button><button class="delete btn btn-sm btn-primary" id="d'.$arr['sno'].'">Delete</button></td></tr>';
              }
            ?>
